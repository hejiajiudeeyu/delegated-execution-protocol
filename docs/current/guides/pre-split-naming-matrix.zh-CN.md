...
- 兼容窗与迁移细节见[rename-local-state-migration-map.md](/Users/hejiajiudeeyu/Documents/Projects/remote-hotline-protocol/docs/current/guides/rename-local-state-migration-map.md)。
